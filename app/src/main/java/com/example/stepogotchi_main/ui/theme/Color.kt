package com.example.stepogotchi_main.ui.theme
...
val bluel = Color(0xFF5A55E2)
val brightBlue = Color(0xFF027cf5)
val yellow = Color(0xFFFFC268)
val yellowl = Color(0xFFF7D19A)